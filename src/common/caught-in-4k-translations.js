...
const caughtIn4KTranslations = {
    ...
    CALENDAR_EMPTY_STATE: 'New releases calendar. Loading after a nap.',
    ADDONS_PAGE_HEADING: 'Platforms',
    ADD_TO_WATCHLIST_BUTTON: '+ Save it',
    SAVE_TOAST: 'Saved! no pressure tho 😌',
