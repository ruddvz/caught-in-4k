...
C4K scans the Jellyfin movie library for IMDb provider IDs, caches that lookup, fetches the matched Jellyfin item for full metadata, obtains Jellyfin playback metadata for the matching movie, and ranks each available media source.
...
For the Jellyfin-specific lookup, metadata and relay design, see [`docs/architecture/C4K_JELLYFIN_PROVIDER.md`](../docs/architecture/C4K_JELLYFIN_PROVIDER.md).
